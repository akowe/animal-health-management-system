    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-book"></i>  <?php echo lang('medical_history'); ?> | <?php echo $patient->name; ?> | <?php echo $patient->phone; ?>
            </header> 
            <div class="col-md-6">
                                ...
                                <?php foreach ($medical_histories as $medical_history) { ?>
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            ...
                                            <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url();?>medical_history/delete?id=<?php echo $medical_history->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            ...
                            <tbody>
                                <?php foreach ($prescriptions as $prescription) { ?>
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                              <a class="btn btn-info btn-xs btn_width" href="<?php echo site_url();?>prescription/viewPrescription?id=<?php echo $prescription->id; ?>"><i class="fa fa-eye"> <?php echo lang('view'); ?> </i></a>
                                            <?php if ($this->ion_auth->in_group('Doctor')) { ?>
                                                ...
                                                <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url();?>prescription/delete?id=<?php echo $prescription->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div class="panel-body">
                            <?php foreach ($patient_materials as $patient_material) { ?>
                                <div class="panel col-md-3"  style="height: 200px; margin-right: 5px;">
                                    <a class="btn btn-info btn-xs btn_width" href="<?php echo site_url();?>patient/deletePatientMaterial?id=<?php echo $patient_material->id; ?>"onclick="return confirm('Are you sure you want to delete this item?');"> X </a>
                                    <div class="post-info">
                                        <?php
                                        echo '<img src="' . $patient_material->url . '" " width="100px" height="100px">';
                                        ?>
...
<div class="modal fade" id="myModa3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">  
            ...
            <div class="modal-body">
                <form role="form" action="<?php  echo site_url(). 'prescription/addNewPrescription';?>" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
...
<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">  
            ...
            <div class="modal-body">
                <form role="form" id="prescriptionEditForm" action="<?php echo site_url(). 'prescription/addNewPrescription'; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
