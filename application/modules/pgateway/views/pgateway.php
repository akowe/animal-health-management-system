                        ...
                        <tbody> 
                            ...
                            foreach ($pgateways as $pgateway) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-xs btn_width" href="<?php echo site_url(); ?>pgateway/settings?id=<?php echo $pgateway->id; ?>">  <i class="fa fa-edit"> </i> <?php echo lang('manage'); ?></a>
                                        <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url(); ?>pgateway/delete?id=<?php echo $pgateway->id; ?>" <?php echo lang('delete'); ?> onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
