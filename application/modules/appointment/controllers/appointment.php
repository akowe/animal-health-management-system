...
class Appointment extends MX_Controller {
    ...
    public function addNew() {
       ...
       // $patient = $this->input->post('patient');
        ...
        $farm_phone= $this->input->post('farm_phone');
      ...
      //  $this->form_validation->set_rules('patient', 'Patient', 'trim|required|min_length[1]|max_length[100]|xss_clean');
        ...
        // Validating farm Name Field
        $this->form_validation->set_rules('farm', 'Farm Name', 'trim|required|min_length[1]|max_length[100]|xss_clean');

        // Validating farm phone Field
        $this->form_validation->set_rules('farm_phone', 'Farm Phone', 'trim|required|min_length[1]|max_length[100]|xss_clean');

        // Validating farm address Field
        $this->form_validation->set_rules('farm_address', 'Farm Addresse', 'trim|required|min_length[1]|max_length[100]|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (empty($id)) {     // Adding New department
                ...
                if (!empty($sms)) {
                    $this->sms->sendSmsDuringAppointment($patient, $doctor, $farm, $farm_address, $farm_phone, $date, $s_time, $e_time);
                }
    ...
    function getAppointment() {
        ...
        if (!empty($data['appointments'])) {
            $output = array(
                ...
                "recordsTotal" => $this->db->get_where('appointment', array('hospital_id' => $this->hospital_id))->num_rows(),
                "recordsFiltered" => $this->db->get_where('appointment', array('hospital_id' => $this->hospital_id))->num_rows(),
                "data" => $info
            );
        } else {
            $output = array(
