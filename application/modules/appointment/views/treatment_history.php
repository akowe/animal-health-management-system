        ...
        <section class="panel">
            ...
            <div class="col-md-12">
                <div class="col-md-7 panel-body">
                    <section>
                        <form role="form" class="f_report" action="<?php echo site_url() . 'appointment/treatmentReport'?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php foreach ($doctors as $doctor) { ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                 ...
                                 <td> <a class="btn btn-info btn-xs btn_width add_payment_button" style="width: 100px;" href="<?php echo site_url(); ?>appointment/getAppointmentByDoctorId?id=<?php echo $doctor->id; ?>"><i class="fa fa-money"></i>  <?php  echo lang('details'); ?></a></td>
