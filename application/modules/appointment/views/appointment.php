                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th> <?php echo lang('farm_address'); ?></th>
                                <th> <?php echo lang('farm_phone'); ?></th>
                                <th> <?php echo lang('doctor'); ?></th>
                                <th> <?php echo lang('date-time'); ?></th>
                                <th> <?php echo lang('remarks'); ?></th>
                                <th> <?php echo lang('status'); ?></th>
                                <th> <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        ...
                        <?php foreach ($appointments as $appointment) { ?>
                            <tr class="">
                                ...
                                <td ><?php echo $appointment->farm; ?></td>

                                <td ><?php echo $appointment->farm_address; ?></td>

                                <td ><?php echo $appointment->farm_phone; ?></td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url();?>appointment/delete?id=<?php echo $appointment->id; ?>" <?php echo lang('delete'); ?> onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo site_url(). 'appointment/addNew'; ?>" method="post" enctype="multipart/form-data">
                   <!-- Select pateint <div class="col-md-12 panel">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editAppointmentForm" action="<?php echo site_url(). 'appointment/addNew'; ?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                            <label for="exampleInputEmail1"> <?php echo lang('patient'); ?></label>
                        </div>
