    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-plus-circle"></i> <?php echo lang('add_department'); ?>
            </header>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="<?php  echo site_url() . 'department/addNew';?>" method="post">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label class="control-label col-md-3"><?php echo lang('descriptipn'); ?></label>
                                            <div class="col-md-9">
