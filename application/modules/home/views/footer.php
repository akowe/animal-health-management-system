<footer class="site-footer">
    <div class="text-center">
        20<?php echo date('y'); ?> &copy; <?php echo $this->db->get('settings')->row(); ?> <a href="https://livestock247.com" target="_blank" style="color:#fff;">Livestock247.com</a>
...
<!-- fetch -->
<script src="<?php echo base_url().'common/ajax/js/jquery-3.3.1.js'?>" type="text/javascript"></script>
<!--<script src="--><?php //echo base_url().'common/ajax/js/bootstrap.js'?><!--" type="text/javascript"></script>-->
<script src="<?php echo base_url().'common/ajax/js/jquery-ui.js'?>" type="text/javascript"></script>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#chip').autocomplete({
            source: "<?php echo site_url('patient/get_autocomplete');?>",
            dataType: 'json',

            select: function (event, ui) {
                $('[name="chip"]').val(ui.item.label);
