...
class Auth extends CI_Controller {
    ...
    public function forgot_password()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $userInfo = $this->users_model->getUserInfoByEmail($email);
            ...
            $msg = "
					<html>
						...
						<body>
							...
							<a href='" . site_url() . "auth/reset_password?token=" . $qstring . " 'class='btn btn-primary btn-md btn-block' >
...
//        );
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           $post = $this->input->post(NULL, TRUE);
            ...
            $cleanPost['password'] =md5($password) ;
...
//        return base64_decode(str_pad(strtr($data, '-_', '+/'), strlen($data) % 4, '=', STR_PAD_RIGHT));
	...
	public function reset_password1($code = NULL)
	{
		if (!$code)
		{
			show_404();
