                        ...
                        <?php foreach ($accountants as $accountant) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                      ...
                                      <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url(); ?>accountant/delete?id=<?php echo $accountant->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo site_url() . 'accountant/addNew';?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editAccountantForm" action="<?php echo site_url() . 'accountant/addNew';?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?></label>
...
<script type="text/javascript">
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $('#myModal2').modal('show');
                                            $.ajax({
                                                url: 'accountant/editAccountantByJason?id=' + id,
                                                method: 'GET',
                                                data: '',
                                                dataType: 'json',
