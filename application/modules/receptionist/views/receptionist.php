    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-user"></i>  <?php echo lang('customer_support'); ?>
            </header>
                        ...
                        <a data-toggle="modal" href="#myModal">
                            <div class="btn-group">
                                <button id="" class="btn green">
                                    <i class="fa fa-plus-circle"></i>  <?php echo lang('add_support'); ?> 
                                </button>
                            </div>
                        </a>
                        ...
                        <?php foreach ($receptionists as $receptionist) { ?>
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url(); ?>receptionist/delete?id=<?php echo $receptionist->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i>  <?php echo lang('add_support'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" action="<?php echo site_url() . 'receptionist/addNew';?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-edit"></i>  <?php echo lang('edit_support'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editReceptionistForm" action="<?php echo site_url() . 'receptionist/addNew';?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('name'); ?></label>
