            ...
            <div class="panel-body"> 
                <div class="adv-table editable-table">
                    <div class="clearfix search_row">
                        ...
                        <!--
                        <form action="medicine/searchMedicine" method="get" class="search_form">
                            <input type="text" name="key" placeholder="<?php echo lang('search_medicine_or_company'); ?>" value='<?php
                            if (!empty($key)) {
                                echo $key;
                            }
                            ?>'>
...
<!--                                <td>--><?php //echo $medicine->effects; ?><!--</td>-->
                                ...
                                <td>
                                    ...
                                    <a type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $medicine->id; ?>" href="<?php echo site_url(); ?>medicine/editMedicine?id=<?php echo $medicine->id; ?>"><i class="fa fa-edit"></i>  <?php echo lang('edit'); ?></a>
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="<?php echo site_url(); ?>medicine/delete?id=<?php echo $medicine->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i> <?php echo lang('delete'); ?></a>
...
<!--                <form role="form" action="--><?php //echo site_url() . 'medicine/addNewMedicine'; ?><!--" method="post" enctype="multipart/form-data">-->
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editMedicineForm" action=" <?php echo site_url() . 'medicine/addNewMedicine'; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value='' placeholder="">
                    </div>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editMedicineForm" action="<?php echo site_url() . 'medicine/load'; ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        $(document).ready(function () {
                                            $(".editbutton").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: '<?php echo site_url(); ?>medicine/editMedicine?id=<?php echo $medicine->id; ?>,
                                                    method: 'GET',
                                                    data: '',
                                                    dataType: 'json',
