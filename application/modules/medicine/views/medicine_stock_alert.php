    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-medkit"></i>    <?php echo lang('medicine'); ?>  <?php echo lang('alert_stock_list'); ?>
            ...
            <div class="panel-body"> 
                <div class="adv-table editable-table ">
                    <div class="clearfix search_row">
                        ...
                        <!--
                        <form action="medicine/searchMedicineInAlertStock" method="get" class="search_form">
                            <input type="text" name="key" placeholder="search medicine or company" value='<?php
                            if (!empty($key)) {
                                echo $key;
                            }
                            ?>'>
