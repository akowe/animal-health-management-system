...
class Pharmacy_model extends CI_model {
    ...
    {
        $this->db->where('project', 'Rural');
        $query = $this->db->get('patient');
        return $query;
    }

    // select all hoina urban chip
    public function hoinaChipUrban()
    {
        $this->db->where('project', 'Urban');
        $query = $this->db->get('patient');
        return $query;
    }

    public function sebiChip()
    {
        $this->db->where('project', 'Sebi');
        $query = $this->db->get('patient');
        return $query;
    }

    public function alldnChip()
    {
        $this->db->where('project', 'Alddn');
        $query = $this->db->get('patient');
        return $query;
    }
