...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <header class="panel-heading">
            <i class="fa fa-money"></i>  <?php  echo lang('pharmacy'); ?> <?php echo lang('report'); ?> 
        </header>
        <div class="col-md-12">
            <div class="col-md-7">  
                <section>
                    <form role="form" class="f_report" action="<?php echo site_url() . 'finance/pharmacy/financialReport';?>" method="post" enctype="multipart/form-data">
