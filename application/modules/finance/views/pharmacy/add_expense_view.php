    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
                <?php
                if (!empty($expense->id))
                    echo '<i class="fa fa-edit"></i> '. lang('pharmacy'). ' ' .lang('edit_expense');
                else
                    echo '<i class="fa fa-plus-circle"></i> '. lang('pharmacy'). ' ' .lang('add_expense');
                ?>
            </header>
            <div class="">
                        ...
                        <div class="col-md-6">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="<?php echo site_url() .'finance/pharmacy/addExpense';?>" method="post" enctype="multipart/form-data">
