                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="<?php  echo site_url() . 'finance/addPaymentCategory';?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            if (!empty($setval)) {
                                                echo set_value('p_price');
                                            }
                                            if (!empty($category->p_price)) {
                                                echo $category->p_price;
                                            }
                                            ?>' placeholder="">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo lang('sales'); ?> <?php echo lang('price'); ?></label>
