            ...
            <div class=" panel-body col-md-8">
                <div class="adv-table editable-table ">
                    <div class="panel-body no-print pull-left">
                        <a href="<?php  echo site_url();?>finance/addPaymentByPatientView?id=<?php echo $patient->id; ?>&type=gen">
                            <div class="btn-group">
                                <button id="" class="btn">
                    ...
                    <section class="col-md-12 no-print">
                        <form role="form" class="f_report" action="<?php echo site_url() . 'finance/patientPaymentHistory';?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <tr class="">
                                        ...
                                        <td  class="no-print"> 
                                            <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                                <a class="btn btn-info btn-xs width_auto" title="<?php echo lang('edit'); ?>" style="width: 23px;" href="<?php echo site_url();?>finance/editPayment?id=<?php echo $payment->id; ?>"><i class="fa fa-edit"> </i></a>
                                            <?php } ?>
                                            <a class="btn btn-xs invoicebutton width_auto" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 23px;" href="<?php echo site_url();?>finance/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-file-text"></i> </a>
                                            <?php if ($this->ion_auth->in_group(array('admin'))) { ?> 
                                                <a class="btn btn-info btn-xs delete_button width_auto" title="<?php echo lang('delete'); ?>" style="width: 23px;"  href="<?php echo site_url();?>finance/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>
                                            <?php } ?>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    if (!empty($deposit->deposited_amount) && empty($deposit->amount_received_id)) {
                                        ...
                                        <tr class="">
                                            ...
                                            <td  class="no-print"> 
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?> 
                                                        <a class="btn btn-info btn-xs delete_button width_auto" title="<?php echo lang('delete'); ?>" style="width: 23px;" href="<?php echo site_url();?>finance/deleteDeposit?id=<?php echo $deposit->id; ?>&patient=<?php echo $patient->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                                                    <?php } ?>
                                            </td>
                                        </tr>
                                        <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo site_url() . 'payu/check';?>" id="deposit-form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="clearfix">
                    <div class="col-lg-12 clearfix">
                        ...
                        <a href="<?php echo site_url();?>finance/addPaymentByPatientView?id=<?php echo $patient->id; ?>&type=ot">
                            <div class="col-lg-6">
                                <div class="flat-carousal" style="background: #39B27C;">
                                    <div id="owl-demo" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editDepositform" action="<?php echo site_url(). 'finance/deposit';?>" method="post" enctype="multipart/form-data">
                    <div class="payment_label"> 
                        <label for="exampleInputEmail1"><?php echo lang('invoice'); ?></label> 
                        <select class="form-control m-bot15 js-example-basic-single" id="" name="payment_id" value=''> 
                            <option value="">Select .....</option>
