    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-money"></i>  <?php echo lang('activities_by'); ?> <strong style="color: whitesmoke; text-transform: capitalize;" ><?php echo $user->name; ?></strong>
                ( <?php
                if (!empty($date_from)) {
            ...
            <div class="panel-body">
                <?php if ($this->ion_auth->in_group(array('Accountant', 'Receptionist'))) { ?>
                    <section class="col-md-4 no-print">
                        <a href="<?php echo site_url(); ?>finance/UserActivityReport?user=<?php echo $user->ion_user_id; ?>">
                            <div class="btn-group">
                        ...
                        <a href="<?php echo site_url(); ?>finance/UserActivityReport?user=<?php echo $user->ion_user_id; ?>&yesterday='all'">
                            <div class="btn-group">
                                <button id="" class="btn <?php
                                if (!empty($day)) {
                                    if ($day == 'Yesterday') {
                        ...
                        <a href="<?php echo site_url(); ?>finance/UserActivityReport?user=<?php echo $user->ion_user_id; ?>&all='all'">
                            <div class="btn-group">
                                <button id="" class="btn <?php
                                if (!empty($day)) {
                                    if ($day == 'All') {
                    ...
                    <section class="col-md-6 no-print">
                        <form role="form" class="f_report" action="<?php echo site_url() . 'finance/userActivityReportDateWise'; ?>" method="post" enctype="multipart/form-data">
                ...
                <?php if ($this->ion_auth->in_group(array('admin')) || $this->ion_auth->get_user_id() == '341') { ?>
                    <section class="col-md-4 no-print">
                        <a href="<?php echo site_url(); ?>finance/allUserActivityReport?user=<?php echo $user->ion_user_id; ?>">
                            <div class="btn-group">
                                <button id="" class="btn <?php
                                if (!empty($day)) {
                                    if ($day == 'Today') {
                        ...
                        <a href="<?php echo site_url(); ?>finance/allUserActivityReport?user=<?php echo $user->ion_user_id; ?>&yesterday='all'">
                            <div class="btn-group">
                                <button id="" class="btn <?php
                                if (!empty($day)) {
                                    if ($day == 'Yesterday') {
                        ...
                        <a href="<?php echo site_url(); ?>finance/allUserActivityReport?user=<?php echo $user->ion_user_id; ?>&all='all'">
                            <div class="btn-group">
                                <button id="" class="btn <?php
                                if (!empty($day)) {
                                    if ($day == 'All') {
                    ...
                    <section class="col-md-6">
                        <form role="form" class="f_report" action="<?php echo site_url() . 'finance/allUserActivityReportDateWise'; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <!--     <label class="control-label col-md-3">Date Range</label> -->
                                <div class="col-md-6">
                                    <div class="input-group input-large" data-date="13/07/2013" data-date-format="mm/dd/yyyy">
            ...
            <div class="col-md-8">
                <div class="adv-table editable-table ">
                    <header class="panel-heading">
                        <i class="fa fa-money"></i>  <?php echo lang('all_bills'); ?>
                    </header>
