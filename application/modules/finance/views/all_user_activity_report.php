    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-money"></i>  <?php echo lang('activities_by'); ?> <strong style="color: whitesmoke; text-transform: capitalize;" ><?php echo lang('all_users'); ?></strong> (<?php echo lang('today'); ?>)
            </header>
            <div class="panel-body col-md-12">
                <div class="adv-table editable-table ">
                    ...
                    <header class="panel-heading">
                        <i class="fa fa-money"></i>  <?php echo lang('today'); ?> <?php echo lang('report'); ?>
                    </header>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        ...
                        <?php foreach ($accountants as $accountant) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                      <a class="btn btn-info btn-xs btn_width add_payment_button" style="width: 100px;" href="<?php echo site_url(); ?>finance/allUserActivityReport?user=<?php echo $accountant_ion_user_id; ?>"><i class="fa fa-info"></i> Details</a>
                                </td>
                            </tr>
                        <?php } ?>
                            ...
                            <tr class="">
                                ...
                                <td class="no-print">
                                      <a class="btn btn-info btn-xs btn_width add_payment_button" style="width: 100px;" href="<?php echo site_url(); ?>finance/allUserActivityReport?user=<?php echo $receptionist_ion_user_id; ?>"><i class="fa fa-info"></i> Details</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
