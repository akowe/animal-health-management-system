...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-md-12 panel-body">
            <div class="col-md-7">
                <section>
                    <form role="form" class="f_report" action="<?php echo site_url() . 'finance/financialReport'; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($payment_categories as $cat_name) {
                                foreach ($payments as $payment) {
                                    ...
                                    foreach ($categories_in_payment as $key => $category_in_payment) {
                                        ...
                                        if ($category_id[0] == $cat_name->category) {
                            ...
                            foreach ($payment_categories as $category) {
                                  $category_quantity = 0;
                                if (in_array($category->category, $category_id_for_reports)) {
                                    ?>
                                    <tr class="">
                                        ...
                                        <td>
                                            ...
                                            foreach ($payments as $paymentt) {
                                                ...
                                                foreach ($category_names_and_amountss as $category_name_and_amountt) {
                                                    ...
                                                    if (($category->category == $category_namee[0])) {
                                                        $category_quantity = $category_quantity + 1;
                                                    }
                                                }
                                            }
