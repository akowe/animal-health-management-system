    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
              <i class="fa fa-money"></i>   <?php echo lang('doctors_commission'); ?>
            </header>
            <div class="space15"></div> 
            <div class="col-md-12">
                <div class="col-md-7">
                    <section class="panel-body">
                        <form role="form" action="<?php echo site_url() . 'finance/doctorsCommission' ?>" class="clearfix" method="post" enctype="multipart/form-data">
                        ...
                        <?php foreach ($doctors as $doctor) { ?>
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $settings->currency; ?>
                                 ...
                                 <td> <a class="btn btn-info btn-xs invoicebutton" href="<?php echo site_url(); ?>finance/docComDetails?id=<?php echo $doctor->id; ?>"><i class="fa fa-file-text"></i> <?php echo lang('details'); ?> </a></td>
                            </tr>
